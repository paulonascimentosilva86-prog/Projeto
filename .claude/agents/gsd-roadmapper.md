...
Reference full template: `/home/user/Projeto/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/Projeto/.claude/get-shit-done/templates/state.md`.
