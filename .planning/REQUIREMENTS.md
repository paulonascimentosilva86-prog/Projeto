...
- [x] **HOOK-01**: Hook bloqueante (exit 1) para petições sem endereçamento
- [x] **HOOK-02**: Hook bloqueante (exit 1) para petições sem qualificação das partes
- [x] **HOOK-03**: Hook bloqueante (exit 1) para petições sem pedidos
- [x] **HOOK-04**: Validação por tipo de petição (condominial exige planilha, trabalhista exige verbas)
- [x] **HOOK-05**: Testes do hook com BATS (petição completa, incompleta, vazia)
