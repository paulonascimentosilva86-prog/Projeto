...
echo -e "${CYAN}║${NC}  ${BOLD}Familia${NC}       - Divorcio, alimentos, inventario         ${CYAN}║${NC}"
echo -e "${CYAN}║${NC}  ${BOLD}Produtividade${NC} - Relatorios, honorarios, minutas         ${CYAN}║${NC}"
echo -e "${CYAN}╠══════════════════════════════════════════════════════════╣${NC}"
echo -e "${CYAN}║              SKILLS FASE 1 (CORE)                        ║${NC}"
echo -e "${CYAN}╠══════════════════════════════════════════════════════════╣${NC}"
echo -e "${CYAN}║${NC}  /execucao-condominial    /calculadora-condominial      ${CYAN}║${NC}"
echo -e "${CYAN}║${NC}  /workflow-cobranca       /peticao-trabalhista          ${CYAN}║${NC}"
echo -e "${CYAN}║${NC}  /defesa-trabalhista      /peticao-civel               ${CYAN}║${NC}"
echo -e "${CYAN}║${NC}  /execucao-cumprimento    /acao-consumo                ${CYAN}║${NC}"
echo -e "${CYAN}║${NC}  /conversor-linguagem     /analise-processo            ${CYAN}║${NC}"
echo -e "${CYAN}╠══════════════════════════════════════════════════════════╣${NC}"
