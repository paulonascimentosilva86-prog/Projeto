...
echo -e "${CYAN}║${NC}  ${BOLD}Hermes${NC}        - Pesquisa web + NotebookLM + estrategia  ${CYAN}║${NC}"
echo -e "${CYAN}╠══════════════════════════════════════════════════════════╣${NC}"
...
echo -e "${CYAN}║${NC}  ${BOLD}Hermes/Pesquisa (2):${NC} pesquisa-profunda,              ${CYAN}║${NC}"
echo -e "${CYAN}║${NC}    workflow-pesquisa (busca web + NotebookLM)            ${CYAN}║${NC}"
echo -e "${CYAN}╠══════════════════════════════════════════════════════════╣${NC}"
